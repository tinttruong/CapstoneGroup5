...
export class CheckoutComponent implements OnInit {
  ...
  // disable field while REST API calls are in progress
  ...
  ngOnInit(): void {
    ...
    // read the user's eamil address from browser storage
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      ...
      customer: this.formBuilder.group({
        ...
        // with form validations using FormControl
  ...
  // getters for firstName, lastName, and email
